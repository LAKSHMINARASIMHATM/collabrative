...
const ClientSideSuspense = ({ children, fallback })=>{
    // Basic mock of Suspense for now since we removed Liveblocks
...
const useStorage = ()=>null;
const useMutation = ()=>()=>{};
const useHistory = ()=>({
        undo: ()=>{},
        redo: ()=>{}
    });
const useCanUndo = ()=>false;
const useCanRedo = ()=>false;
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__81c73329._.js.map