...
"[project]/node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/babel.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
- Did you mean \`import { "${a}" as foo }\`?`,
        ...
        PipeUnparenthesizedBody: ({ type: a })=>`Hack-style pipe body cannot be an unparenthesized ${be({
                type: a
    ...
    function F(a, t) {
        ...
        for (let s of Object.keys(a)){
            let i = a[s], r = typeof i == "string" ? {
                ...
                message: i
            } : i, { message: n } = r, o = Ys(r, ri), h = typeof n == "string" ? ()=>n : n;
    ...
    var Bi = /\*?\s*@((?:no)?flow)\b/, Ri = (a)=>class extends a {
            ...
            checkReservedType(e, s, i) {
                Di.has(e) && this.raise(i ? g.AssignReservedType : g.UnexpectedReservedType, s, {
                    reservedType: e
                });
            }
                    ...
                    case 10:
                        {
                            ...
                            ]) : i = this.flowParseFunctionTypeParams(), h.params = i.params, h.rest = i.rest, h.this = i._this, this.expect(11), this.expect(19), h.returnType = this.flowParseType(), h.typeParameters = null, this.finishNode(h, "FunctionTypeAnnotation");
                        }
                    case 134:
            ...
            flowEnumParseExplicitType({ enumName: e }) {
                ...
                if (!w(this.state.type)) throw this.raise(g.EnumInvalidExplicitTypeUnknownSupplied, this.state.startLoc, {
                    enumName: e
                });
                    ...
                    default:
                        {
                            ...
                            if (!u && !f && !d && !x) return l();
                            if (!u && !f) return e.members = this.flowEnumStringMembers(o.stringMembers, o.defaultedMembers, {
                                enumName: i
                            }), this.expect(8), this.finishNode(e, "EnumStringBody");
                            if (!f && !d && u >= x) {
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
            ...
            jsxParseElementAt(e) {
                ...
                if (!r.selfClosing) {
                    ...
                    V(r) && !V(n) && n !== null ? this.raise(U.MissingClosingTagFragment, n) : !V(r) && V(n) ? this.raise(U.MissingClosingTagElement, n, {
                        openingTagName: J(r.name)
                    }) : !V(r) && !V(n) && J(n.name) !== J(r.name) && this.raise(U.MissingClosingTagElement, n, {
                        openingTagName: J(r.name)
                    });
                }
...
`);
    ...
    var Ki = new Set([
        ...
        readRadixNumber(t) {
            ...
            r == null && this.raise(p.InvalidDigit, D(s, 2), {
                radix: t
            });
        ...
        checkKeywordEscapes() {
            ...
            bt(t) && this.state.containsEsc && this.raise(p.InvalidEscapedReservedWord, this.state.startLoc, {
                reservedWord: z(t)
            });
        }
        raise(t, e, s = {}) {
        ...
        errorHandlers_readInt = {
            invalidDigit: (t, e, s, i)=>this.optionFlags & 2048 ? (this.raise(p.InvalidDigit, he(t, e, s), {
                    radix: i
                }), !0) : !1,
    ...
    var ot = class extends it {
        addExtra(t, e, s, i = !0) {
            if (!t) return;
            let { extra: r } = t;
            r == null && (r = {}, t.extra = r), i ? r[e] = s : Object.defineProperty(r, e, {
                enumerable: i,
                value: s
            });
        }
        ...
        constructor(t, e, s){
            this.start = e, this.end = 0, this.loc = new Q(s), t?.optionFlags & 128 && (this.range = [
                e,
                0
        ...
        checkLVal(t, e, s = 64, i = !1, r = !1, n = !1, o = !1) {
            ...
            let A = h === "ArrayPattern" || h === "ObjectPattern" ? {
                type: h
            } : e, k = t[d];
    ...
    var Qi = (a)=>class extends a {
            ...
            tsParseModifiers({ allowedModifiers: e, disallowedModifiers: s, stopOnStartOfClassStaticBlock: i, errorTemplate: r = y.InvalidModifierOnTypeMember }, n) {
                let o = (l, u, f, d)=>{
                    u === f && n[d] && this.raise(y.InvalidModifiersOrder, l, {
                        orderedModifiers: [
                            f,
                            d
                        ]
                    ...
                    (n[f] && u === d || n[d] && u === f) && this.raise(y.IncompatibleModifiers, l, {
                        modifiers: [
                            f,
                            d
                        ]
                ...
                for(;;){
                    ...
                    if (!u) break;
                    $t(u) ? n.accessibility ? this.raise(y.DuplicateAccessibilityModifier, l, {
                        modifier: u
                    }) : (o(l, u, u, "override"), o(l, u, u, "static"), o(l, u, u, "readonly"), n.accessibility = u) : Yi(u) ? (n[u] && this.raise(y.DuplicateModifier, l, {
                        modifier: u
                    }), n[u] = !0, o(l, u, "in", "out")) : (Object.prototype.hasOwnProperty.call(n, u) ? this.raise(y.DuplicateModifier, l, {
                        modifier: u
                    }) : (o(l, u, "static", "readonly"), o(l, u, "static", "override"), o(l, u, "override", "readonly"), o(l, u, "abstract", "override"), h(l, u, "declare", "override"), h(l, u, "static", "abstract")), n[u] = !0), s?.includes(u) && this.raise(r, l, {
                        modifier: u
                    });
                }
            }
            ...
            tsParseImportTypeOptions() {
                ...
                this.expect(5);
                let s = this.startNode();
                return this.isContextual(76) ? (s.method = !1, s.key = this.parseIdentifier(!0), s.computed = !1, s.shorthand = !1) : this.unexpected(null, 76), this.expect(14), s.value = this.tsParseImportTypeWithPropertyValue(), e.properties = [
                    this.finishObjectProperty(s)
                ], this.eat(12), this.expect(8), this.finishNode(e, "ObjectExpression");
            }
            ...
            tsParseBindingListForSignature() {
                ...
                for (let s of e){
                    let { type: i } = s;
                    (i === "AssignmentPattern" || i === "TSParameterProperty") && this.raise(y.UnsupportedSignatureParameterKind, s, {
                        type: i
                    });
                }
                return e;
            ...
            tsParseTemplateLiteralType() {
                {
                    let e = this.state.startLoc, s = this.parseTemplateElement(!1), i = [
                        s
                    ];
                    if (s.tail) {
            ...
            tsParseTypePredicateAsserts() {
                ...
                return this.next(), !w(this.state.type) && !this.match(78) ? !1 : (e && this.raise(p.InvalidEscapedReservedWord, this.state.lastTokStartLoc, {
            ...
            tsParseHeritageClause(e) {
                let s = this.state.startLoc, i = this.tsParseDelimitedList("HeritageClauseElement", ()=>{
                    {
                        ...
                        pt(r) || this.raise(y.InvalidHeritageClauseType, r.loc.start, {
                            token: e
                        });
                ...
                return i.length || this.raise(y.EmptyHeritageClauseType, s, {
                    token: e
                }), i;
            }
            ...
            tsTryParseDeclare(e) {
                ...
                return this.tsInAmbientContext(()=>{
                    switch(s){
                        ...
                        case 129:
                            {
                                let i = this.tsParseInterfaceDeclaration(e, {
                                    declare: !0
                                });
                                if (i) return i;
                            }
            ...
            parseClassMemberWithIsStatic(e, s, i, r) {
                ...
                if (n) {
                    e.body.push(n), s.abstract && this.raise(y.IndexSignatureHasAbstract, s), s.accessibility && this.raise(y.IndexSignatureHasAccessibility, s, {
                        modifier: s.accessibility
                    }), s.declare && this.raise(y.IndexSignatureHasDeclare, s), s.override && this.raise(y.IndexSignatureHasOverride, s);
                    return;
                }
            ...
            parseClassProperty(e) {
                if (this.parseClassPropertyAnnotation(e), this.state.isAmbientContext && !(e.readonly && !e.typeAnnotation) && this.match(29) && this.raise(y.DeclareClassFieldHasInitializer, this.state.startLoc), e.abstract && this.match(29)) {
                    ...
                    this.raise(y.AbstractPropertyHasInitializer, this.state.startLoc, {
                        propertyName: s.type === "Identifier" && !e.computed ? s.name : `[${this.input.slice(this.offsetToSourcePos(s.start), this.offsetToSourcePos(s.end))}]`
                    });
                }
                return super.parseClassProperty(e);
            }
            parseClassPrivateProperty(e) {
                return e.abstract && this.raise(y.PrivateElementHasAbstract, e), e.accessibility && this.raise(y.PrivateElementHasAccessibility, e, {
            ...
            pushClassMethod(e, s, i, r, n, o) {
                ...
                l && (u === "get" || u === "set") && this.raise(y.DeclareAccessor, s, {
                    kind: u
            ...
            parseMaybeAssign(e, s) {
                ...
                let o, h = this.tryParse((l)=>{
                    ...
                    if ((u.type !== "ArrowFunctionExpression" || u.extra?.parenthesized) && l(), o?.params.length !== 0 && this.resetStartLocationFromNode(u, o), u.typeParameters = o, this.hasPlugin("jsx") && u.typeParameters.params.length === 1 && !u.typeParameters.extra?.trailingComma) {
                        ...
                        f.constraint || this.raise(y.SingleTypeParameterWithoutTrailingComma, D(f.loc.end, 1), {
            ...
            parseMethod(e, s, i, r, n, o, h) {
                ...
                if ((l.abstract || l.type === "TSAbstractMethodDefinition") && (this.hasPlugin("estree") ? l.value : l).body) {
                    ...
                    this.raise(y.AbstractMethodHasImplementation, l, {
                        methodName: d.type === "Identifier" && !l.computed ? d.name : `[${this.input.slice(this.offsetToSourcePos(d.start), this.offsetToSourcePos(d.end))}]`
                    });
                }
                return l;
            }
    ...
    var Kt = F`placeholders`({
        ...
        UnexpectedSpace: "Unexpected space in placeholder."
            ...
            parseExport(e, s) {
                ...
                return n.exported = i, r.specifiers = [
    ...
    var cs = {
        ...
        getExpression() {
            ...
            if (!this.match(140)) throw this.raise(p.ParseExpressionExpectsEOF, this.state.startLoc, {
        ...
        parseExprOp(t, e, s) {
            if (this.isPrivateName(t)) {
                ...
                (s >= Ae(58) || !this.prodParam.hasIn || !this.match(58)) && this.raise(p.PrivateInExpectedIn, t, {
                    identifierName: r
        ...
        parseHackPipeBody() {
            ...
            return si.has(e.type) && !e.extra?.parenthesized && this.raise(p.PipeUnparenthesizedBody, t, {
                type: e.type
            }), this.topicReferenceWasUsedInCurrentContext() || this.raise(p.PipeTopicUnused, t), e;
        }
        ...
        finishTopicReference(t, e, s, i) {
            ...
            throw this.raise(p.PipeTopicUnconfiguredToken, e, {
                token: z(i)
            });
        }
...
`),
        ...
        parseTemplate(t) {
            let e = this.startNode(), s = this.parseTemplateElement(t), i = [
                s
            ], r = [];
        ...
        parsePropertyDefinition(t) {
            ...
            if (this.parsePropertyName(s, t), !o && !h && this.maybeAsyncOrAccessorProp(s)) {
                ...
                u === "async" && !this.hasPrecedingLineBreak() && (i = !0, this.resetPreviousNodeTrailingComments(l), o = this.eat(55), this.parsePropertyName(s)), (u === "get" || u === "set") && (r = !0, this.resetPreviousNodeTrailingComments(l), s.kind = u, this.match(55) && (o = !0, this.raise(p.AccessorIsGenerator, this.state.curPosition(), {
                    kind: u
        ...
        parseExprListItem(t, e, s, i) {
            let r;
            if (this.match(12)) e || this.raise(p.UnexpectedToken, this.state.curPosition(), {
                unexpected: ","
            }), r = null;
    ...
    var ft = class extends ut {
        ...
        parseProgram(t, e, s) {
            if (t.sourceType = s, t.interpreter = this.parseInterpreterDirective(), this.parseBlockBody(t, !0, !0, e), this.inModule) {
                if (!(this.optionFlags & 64) && this.scope.undefinedExports.size > 0) for (let [r, n] of Array.from(this.scope.undefinedExports))this.raise(p.ModuleExportUndefined, n, {
                    localName: r
                });
        ...
        parseVarId(t, e) {
            ...
            e === "using" || e === "await using" ? (s.type === "ArrayPattern" || s.type === "ObjectPattern") && this.raise(p.UsingDeclarationHasBindingPattern, s.loc.start) : s.type === "VoidPattern" && this.raise(p.UnexpectedVoidPattern, s.loc.start), this.checkLVal(s, {
        ...
        isExportDefaultSpecifier() {
            ...
            if (w(t)) {
                ...
                if ((t === 130 || t === 129) && !this.state.containsEsc) {
                    ...
                    if (r === 123 || this.chStartsBindingIdentifier(r, i) && !this.input.startsWith("from", i)) return this.expectOnePlugin([
                        "flow",
                        "typescript"
                    ]), !1;
                }
        ...
        parseImportAttributes() {
            ...
            do {
                ...
                if (e.has(i) && this.raise(p.ModuleAttributesWithDuplicateKeys, this.state.startLoc, {
                    key: i
                }), e.add(i), this.match(134) ? s.key = this.parseStringLiteral(i) : s.key = this.parseIdentifier(!0), this.expect(14), !this.match(134)) throw this.raise(p.ModuleAttributeInvalidValue, this.state.startLoc);
        ...
        parseModuleAttributes() {
            ...
            do {
                ...
                if (s.key = this.parseIdentifier(!0), s.key.name !== "type" && this.raise(p.ModuleAttributeDifferentFromType, s.key), e.has(s.key.name) && this.raise(p.ModuleAttributesWithDuplicateKeys, s.key, {
                    key: s.key.name
                }), e.add(s.key.name), this.expect(14), !this.match(134)) throw this.raise(p.ModuleAttributeInvalidValue, this.state.startLoc);
                s.value = this.parseStringLiteral(this.state.value), t.push(this.finishNode(s, "ImportAttribute"));
            }while (this.eat(12))
            return t;
        }
...
`);
    ...
    function Er(a) {
        ...
        for(let e = a.length - 1; e >= 0; e--){
            let s = a[e];
            if (t && L(s) === M(t) && Et(s) && Et(t) && (a.splice(e + 1, 1), s.value += "*//*" + t.value, s.range = [
                M(s),
                L(t)
            ]), !Ts(s) && !se(s)) throw new TypeError(`Unknown comment type: "${s.type}".`);
            t = s;
        }
    }
    var As = Er;
    ...
    function Lr(a, t) {
        ...
        n.interpreter && (i.unshift(n.interpreter), delete n.interpreter), r && a.hashbang && (i.unshift(a.hashbang), delete a.hashbang), a.type === "Program" && (a.range = [
            0,
            s.length
        ]);
        let o;
                    ...
                    case "ParenthesizedExpression":
                        {
                            ...
                            if (l.type === "TypeCastExpression") return l.range = [
                                u,
                                L(h)
                            ], l;
                            let f = !1;
...
`);
    ...
    var Xr = new Set([
        ...
        optionsCombinations: qs.map((a)=>_([
                "estree"
            ], a))
    });
    var Dt = {};
...
//# sourceMappingURL=b0a32_prettier_plugins_babel_0c72ca7e.js.map