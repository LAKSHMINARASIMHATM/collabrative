...
"[project]/node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/html.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(f) {
    ...
    var en = (e, t)=>{
        for(var r in t)_t(e, r, {
            get: t[r],
            enumerable: !0
        });
    }, xs = (e, t, r, n)=>{
        if (t && typeof t == "object" || typeof t == "function") for (let i of ks(t))!As.call(e, i) && i !== r && _t(e, i, {
            get: ()=>t[i],
            enumerable: !(n = ws(t, i)) || n.enumerable
        });
        return e;
    };
    var Ns = (e)=>xs(_t({}, "__esModule", {
            value: !0
        }), e);
    var sr = (e, t, r)=>ys(e, typeof t != "symbol" ? t + "" : t, r), Ls = (e, t, r)=>t.has(e) || Zr("Cannot " + r);
    var $e = (e, t, r)=>(Ls(e, t, "read from private field"), r ? r.call(e) : t.get(e)), tn = (e, t, r)=>t.has(e) ? Zr("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r);
    var Dl = {};
    en(Dl, {
        languages: ()=>ms,
        options: ()=>ds,
    ...
    var Ps = String.prototype.replaceAll ?? function(e, t) {
        return e.global ? this.replace(e, t) : this.split(e).join(t);
    }, Os = Ae("replaceAll", function() {
        if (typeof this == "string") return Ps;
    }), w = Os;
    function Ds(e) {
        return this[e < 0 ? this.length + e : e];
    }
    var Rs = Ae("at", function() {
        if (Array.isArray(this) || typeof this == "string") return Ds;
    }), F = Rs;
    var Is = ()=>{}, ze = Is;
    var Ye = "string", je = "array", St = "cursor", ye = "indent", xe = "align", Et = "trim", Ne = "group", Le = "fill", Pe = "if-break", Oe = "indent-if-break", Ct = "line-suffix", vt = "line-suffix-boundary", Y = "line", Tt = "label", De = "break-parent", bt = new Set([
        St,
        ye,
        xe,
        Et,
    ...
    var wt = Ms;
    var Bs = (e)=>new Intl.ListFormat("en-US", {
            type: "disjunction"
        }).format(e);
    function Fs(e) {
...
Expected it to be ${n}.`;
    ...
    function L(e, t = nn) {
        return or(e, (r)=>typeof r == "string" ? q(t, r.split(`
`)) : r);
    }
    ...
    function Gs(e, t) {
        let { preferred: r, alternate: n } = t === !0 || t === "'" ? Us : Ws, { length: i } = e, s = 0, a = 0;
        for(let o = 0; o < i; o++){
...
`,
    ...
    function fn(e, t, r) {
        ...
        if (e.kind === "docType" && (t.value = w(0, e.value.toLowerCase(), /\s+/gu, " ")), e.kind === "angularControlFlowBlock" && e.parameters?.children) for (let n of t.parameters.children)js.has(e.name) ? delete n.expression : n.expression = n.expression.trim();
    ...
    var gn = Xs;
    var Ks = Array.prototype.toReversed ?? function() {
        return [
            ...this
        ].reverse();
    }, Qs = Ae("toReversed", function() {
    ...
    function sa(e, t) {
        ...
        return (na(r, t.language) ?? vn(r, t.physicalFile) ?? vn(r, t.file) ?? Tn(r, t.physicalFile) ?? Tn(r, t.file) ?? ia?.(r, t.physicalFile))?.parsers[0];
    }
    var yt = sa;
    var xt = Symbol.for("PRETTIER_IS_FRONT_MATTER");
    function aa(e) {
        return !!e?.[xt];
    }
    var le = aa;
...
`)), F(0, u, -1).length;
    ...
    function Nt(e, t) {
        return !!(e.kind === "ieConditionalComment" && e.lastChild && !e.lastChild.isSelfClosing && !e.lastChild.endSourceSpan || e.kind === "ieConditionalComment" && !e.complete || ue(e) && e.children.some((r)=>r.kind !== "text" && r.kind !== "interpolation") || Ot(e, t) && !H(e, t) && e.kind !== "interpolation");
    }
    function pe(e) {
    ...
    function xn(e, t) {
        ...
        ;
        function n() {
            return le(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.prev && (e.prev.kind === "text" || e.prev.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : ue(e.parent) ? !0 : !(!e.prev && (e.parent.kind === "root" || ue(e) && e.parent || H(e.parent, t) || Je(e.parent, t) || !_a(e.parent.cssDisplay)) || e.prev && !Ca(e.prev.cssDisplay));
        }
    }
    function Nn(e, t) {
        return le(e) || e.kind === "angularControlFlowBlock" ? !1 : (e.kind === "text" || e.kind === "interpolation") && e.next && (e.next.kind === "text" || e.next.kind === "interpolation") ? !0 : !e.parent || e.parent.cssDisplay === "none" ? !1 : ue(e.parent) ? !0 : !(!e.next && (e.parent.kind === "root" || ue(e) && e.parent || H(e.parent, t) || Je(e.parent, t) || !Sa(e.parent.cssDisplay)) || e.next && !Ea(e.next.cssDisplay));
    }
    function Ln(e, t) {
    ...
    function Pn(e) {
        return _r(e) || e.kind === "element" && e.children.length > 0 && ([
            "body",
            "script",
            "style"
        ].includes(e.name) || e.children.some((t)=>ma(t))) || e.firstChild && e.firstChild === e.lastChild && e.firstChild.kind !== "text" && Dn(e.firstChild) && (!e.lastChild.isTrailingSpaceSensitive || Rn(e.lastChild));
    }
    function _r(e) {
    ...
    function Lt(e) {
        return In(e) || e.prev && ha(e.prev) || On(e);
    }
    function ha(e) {
    ...
    function Bn(e, t) {
        ...
        let r = !1;
        if (e.kind === "element" && e.namespace === "svg") if (Ta(e, (n)=>n.fullName === "svg:foreignObject")) r = !0;
        ...
        switch(t.htmlWhitespaceSensitivity){
            ...
            case "ignore":
                return "block";
            default:
                if (e.kind === "element" && (!e.namespace || r || ce(e)) && Object.prototype.hasOwnProperty.call(mr, e.name)) return mr[e.name];
        }
        return bn;
    }
    function Fn(e) {
        return e.kind === "element" && (!e.namespace || ce(e)) && Object.prototype.hasOwnProperty.call(fr, e.name) ? fr[e.name] : wn;
    }
    function Er(e) {
        return w(0, w(0, e, "&apos;", "'"), "&quot;", '"');
    }
    ...
    function Je(e, t) {
        return he(e, t) && !ba.has(e.fullName);
    }
    function he(e, t) {
    ...
    function Dt(e, t = e.value) {
        return e.parent.isWhitespaceSensitive ? e.parent.isIndentationSensitive ? L(t) : L(x.dedentString(dr(t)), v) : q(_, x.split(t));
    }
    function Rt(e, t) {
    ...
    function Aa(e, t, { node: r }) {
        let n = b(r);
        return K(At(Dt(r, n.trim())), !n.includes("@@"));
    }
    var Gn = ka;
    ...
    var xa = new Set(vr), Yn = ({ node: e }, t)=>xa.has(e.fullName) && !t.parentParser && !e.value.includes("{{"), jn = (e, t, r)=>A(b(r.node), e, {
            parser: "babel",
...
` || e === "\f" || e === "\r" || e === " ";
    ...
    var La = /^[ \t\n\r\u000c]+/, Pa = /^[, \t\n\r\u000c]+/, Oa = /^[^ \t\n\r\u000c]+/, Da = /[,]+$/, Zn = /^\d+$/, Ra = /^-?(?:[0-9]+|[0-9]*\.[0-9]+)(?:[eE][+-]?[0-9]+)?$/;
    function Ia(e) {
        ...
        for(;;){
            ...
            c = o, r = u(Oa), n = [], r.slice(-1) === "," ? (r = r.replace(Da, ""), S()) : d();
        }
        function d() {
        ...
        function S() {
            let m = !1, g, E, P, z, oe = {}, ee, gt, ke, Ge, ir;
            for(z = 0; z < n.length; z++)ee = n[z], gt = ee[ee.length - 1], ke = ee.substring(0, ee.length - 1), Ge = parseInt(ke, 10), ir = parseFloat(ke), Zn.test(ke) && gt === "w" ? ((g || E) && (m = !0), Ge === 0 ? m = !0 : g = Ge) : Ra.test(ke) && gt === "x" ? ((g || E || P) && (m = !0), ir < 0 ? m = !0 : E = ir) : Zn.test(ke) && gt === "h" ? ((P || E) && (m = !0), Ge === 0 ? m = !0 : P = Ge) : m = !0;
            if (!m) oe.source = {
                value: r,
                startOffset: c
            }, g && (oe.width = {
    ...
    function ni(e, t, r) {
        let n = b(r.node), i = ei(n), s = Ma.filter((m)=>i.some((g)=>Object.prototype.hasOwnProperty.call(g, m)));
    ...
    function Ba(e, t) {
        let { root: r } = e;
        return Tr.has(r) || Tr.set(r, r.children.some((n)=>Rt(n, t) && [
                "ts",
                "typescript"
            ].includes(n.attrMap.lang))), Tr.get(r);
    }
    var G = Ba;
    function ai(e, t, r) {
        let n = b(r.node);
    ...
    async function li(e, t, r, n) {
        let i = b(r.node), { left: s, operator: a, right: o } = Fa(i), c = G(r, n);
        return [
    ...
    function Ga(e) {
        return async (t, r, n, i)=>{
            ...
            if (s) return s = or(s, (a)=>typeof a == "string" ? w(0, a, '"', "&quot;") : a), [
                n.node.rawName,
                '="',
                C(s),
                '"'
    ...
    function V(e, t) {
        return ge(e) ? Mt(e.parent, t) : et(e) ? Bt(e.next, t) : "";
    }
    function Mt(e, t) {
        if (mi(e, t)) return "";
        switch(e.kind){
    ...
    function mi(e, t) {
        return !e.isSelfClosing && !e.endSourceSpan && (pe(e) || Nt(e.parent, t));
    }
    function $(e) {
        return e.prev && e.prev.kind !== "docType" && e.kind !== "angularControlFlowBlock" && !O(e.prev) && e.isLeadingSpaceSensitive && !e.hasLeadingSpaces;
    }
    function de(e) {
        return e.lastChild?.isTrailingSpaceSensitive && !e.lastChild.hasTrailingSpaces && !O(Pt(e.lastChild)) && !ue(e);
    }
    function ge(e) {
    ...
    function U(e, t) {
        return tt(e) ? Ft(e.parent) : $(e) ? fe(e.prev, t) : "";
    }
    var hi = "<!doctype";
    function Bt(e, t) {
        switch(e.kind){
    ...
    function Ka(e, t) {
        ...
        return e.lastChild && ge(e.lastChild) ? n += Mt(e, t).length : de(e) && (n -= fe(e.lastChild, t).length), t.originalText.slice(r, n);
    }
    var qt = Ka;
    var Qa = new Set([
        "if",
...
${e}`;
    ...
    function st(e, t, r) {
        ...
        if (pe(n)) {
            ...
            return [
                U(n, t),
                L(x.trimEnd(t.originalText.slice(Q(n) + (n.prev && et(n.prev) ? Bt(n).length : 0), i - (n.next && $(n.next) ? fe(n, t).length : 0)))),
                V(n, t)
            ];
        }
        return r();
    ...
    function Ht(e, t) {
        return O(e) && O(t) ? e.isTrailingSpaceSensitive ? e.hasTrailingSpaces ? Lt(t) ? v : _ : "" : Lt(t) ? v : k : et(e) && (pe(t) || t.firstChild || t.isSelfClosing || t.kind === "element" && t.attrs.length > 0) || e.kind === "element" && e.isSelfClosing && $(t) ? "" : !t.isLeadingSpaceSensitive || Lt(t) || $(t) && e.lastChild && ge(e.lastChild) && e.lastChild.lastChild && ge(e.lastChild.lastChild) ? v : t.hasLeadingSpaces ? _ : k;
    }
    function Ie(e, t, r) {
        let { node: n } = e;
        if (_r(n)) return [
    ...
    function Ai(e, t, r) {
        let { node: n } = e, i = [];
        ro(e) && i.push("} "), i.push("@", n.name), n.parameters && i.push(" (", C(r("parameters")), ")"), i.push(" {");
        let s = yi(n);
    ...
    var no = /-+([a-z0-9])/g;
    function Oi(e) {
        return e.replace(no, (...t)=>t[1].toUpperCase());
    }
    var Ut;
    function xr() {
        return Ut || (Ut = {}, Vt(Ee.HTML, [
            "iframe|srcdoc",
            "*|innerHTML",
            "*|outerHTML"
        ]), Vt(Ee.STYLE, [
    ...
    var io = "boolean", so = "number", ao = "string", oo = "object", lo = [
    ...
    })), co = Array.from(Ri).reduce((e, [t, r])=>(e.set(t, r), e), new Map), Ii = class extends Di {
        constructor(){
            super(), this._schema = new Map, this._eventSchema = new Map, lo.forEach((e)=>{
        ...
        hasProperty(e, t, r) {
            if (r.some((n)=>n.name === yr.name)) return !0;
            if (e.indexOf("-") > -1) {
        ...
        hasElement(e, t) {
            return t.some((r)=>r.name === yr.name) || e.indexOf("-") > -1 && (wr(e) || kr(e) || t.some((r)=>r.name === Ar.name)) ? !0 : this._schema.has(e.toLowerCase());
        }
        securityContext(e, t, r) {
            r && (t = this.getMappedPropName(t)), e = e.toLowerCase(), t = t.toLowerCase();
            let n = xr()[e + "|" + t];
            return n || (n = xr()["*|" + t], n || Ee.NONE);
        }
        getMappedPropName(e) {
            return Ri.get(e) ?? e;
        }
...
If '${e}' is a directive input, make sure the directive is imported by the current module.`
        ...
        allKnownAttributesOfElement(e) {
            ...
            return Array.from(t.keys()).map((r)=>co.get(r) ?? r);
        }
        ...
        normalizeAnimationStyleValue(e, t, r) {
            ...
            if (uo(e) && r !== 0 && r !== "0") if (typeof r == "number") n = "px";
            else {
                let a = r.match(/^[+-]?[\d\.]+([a-z]*)$/);
...
`,
    ...
    function ns(e, t, r, n = {}) {
        let i = new Mo(new ht(e, t), r, n);
        return i.tokenize(), new Oo(Wo(i.tokens), i.errors, i.nonNormalizedIcuExpressions);
    }
    var Do = /\r\n?/g;
    function be(e) {
    ...
    var Br = function(e) {
        ...
        constructor(e, t, r){
            ...
            this._cursor = r.escapedString ? new Go(e, n) : new is(e, n), this._preserveLineEndings = r.preserveLineEndings || !1, this._i18nNormalizeLineEndingsInICUs = r.i18nNormalizeLineEndingsInICUs || !1, this._tokenizeBlocks = r.tokenizeBlocks ?? !0, this._tokenizeLet = r.tokenizeLet ?? !0, this._selectorlessEnabled = r.selectorlessEnabled ?? !1;
            try {
                this._cursor.init();
            } catch (i) {
                this.handleError(i);
        ...
        _processCarriageReturns(e) {
            return this._preserveLineEndings ? e : e.replace(Do, `
`);
        }
        tokenize() {
        ...
        _getBlockName() {
            ...
            return this._attemptCharCodeUntilFn((r)=>lt(r) ? !e : Uo(r) ? (e = !0, !1) : !0), this._cursor.getChars(t).trim();
        }
        ...
        _consumeLetDeclarationValue() {
            ...
            for(this._beginToken(l.LET_VALUE, e); this._cursor.peek() !== 0;){
                ...
                if (t === 59) break;
                Wt(t) && (this._cursor.advance(), this._attemptCharCodeUntilFn((r)=>r === 92 ? (this._cursor.advance(), !1) : r === t)), this._cursor.advance();
            }
            this._endToken([
                this._cursor.getChars(e)
            ]);
        ...
        _tokenizeExpansionForm() {
            ...
            if (Ho(this._cursor.peek()) && this._isInExpansionForm()) return this._consumeExpansionCaseStart(), !0;
        ...
        handleError(e) {
            if (e instanceof Ur && (e = this._createError(e.msg, this._cursor.getSpan(e.cursor))), e instanceof re) this.errors.push(e);
            else throw e;
        }
        _attemptCharCode(e) {
        ...
        _attemptCharCodeCaseInsensitive(e) {
            return Vo(this._cursor.peek(), e) ? (this._cursor.advance(), !0) : !1;
        }
        _requireCharCode(e) {
            let t = this._cursor.clone();
        ...
        _isBlockStart() {
            return this._cursor.peek() === 64 && Io.some((e)=>this._peekStr(e));
        }
        _isLetStart() {
        ...
        _consumeEntity(e) {
            ...
            if (this._cursor.advance(), this._attemptCharCode(35)) {
                ...
                if (this._attemptCharCodeUntilFn(Fo), this._cursor.peek() != 59) {
                    ...
                    throw this._createError(Ro(s, this._cursor.getChars(t)), this._cursor.getSpan());
                }
                ...
                let r = this._cursor.clone();
                if (this._attemptCharCodeUntilFn(qo), this._cursor.peek() != 59) this._beginToken(e, t), this._cursor = r, this._endToken([
                    "&"
                ]);
                else {
        ...
        _consumePrefixAndName(e) {
            ...
            for(; this._cursor.peek() !== 58 && !Bo(this._cursor.peek());)this._cursor.advance();
            let n;
        ...
        _consumeTagOpen(e) {
            let t, r, n, i, s = [];
            try {
                if (this._selectorlessEnabled && Yt(this._cursor.peek())) i = this._consumeComponentOpenStart(e), [n, r, t] = i.parts, r && (n += `:${r}`), t && (n += `:${t}`), this._attemptCharCodeUntilFn(T);
                else {
        ...
        _consumeInterpolation(e, t, r) {
            ...
            for(; this._cursor.peek() !== 0 && (r === null || !r());){
                ...
                this._cursor.advance(), c === 92 ? this._cursor.advance() : c === s ? s = null : !a && s === null && Wt(c) && (s = c);
            }
    ...
    var is = class Fr {
        ...
        advanceState(t) {
            if (t.offset >= this.end) throw this.state = t, new Ur('Unexpected character "EOF"', this);
    ...
    }, Go = class qr extends is {
        constructor(t, r){
            t instanceof qr ? (super(t), this.internalState = {
                ...t.internalState
        ...
        processEscapeSequence() {
            ...
            if (t() === 92) if (this.internalState = {
                ...
                for(; Nr(t()) && n < 3;)i = this.clone(), r += String.fromCodePoint(t()), this.advanceState(this.internalState), n++;
        ...
        decodeHexDigits(t, r) {
            ...
            if (isNaN(i)) throw t.state = t.internalState, new Ur("Invalid hexadecimal escape sequence", t);
            return i;
        }
    ...
    var N = class os extends re {
        ...
        parse(e, t, r, n = !1, i) {
            ...
            } : o, r), p = r && r.canSelfClose || !1, d = r && r.allowHtmComponentClosingTags || !1, S = new zo(u.tokens, a, p, d, n);
            return S.build(), new $o(S.rootNodes, [
                ...u.errors,
                ...S.errors
            ]);
        }
...
`) {
        ...
        _consumeLet(t) {
            ...
            let s = i.sourceSpan.fullStart, a = new h(t.sourceSpan.start, s, t.sourceSpan.fullStart), o = t.sourceSpan.toString().lastIndexOf(r), c = new h(t.sourceSpan.start.moveBy(o), t.sourceSpan.end), u = new Pr(r, n.parts[0], a, c, n.sourceSpan);
            this._addToParent(u);
        }
        _consumeIncompleteLet(t) {
            let r = t.parts[0] ?? "", n = r ? ` "${r}"` : "";
            if (r.length > 0) {
                let i = t.sourceSpan.toString().lastIndexOf(r), s = new h(t.sourceSpan.start.moveBy(i), t.sourceSpan.end), a = new h(t.sourceSpan.start, t.sourceSpan.start.moveBy(0)), o = new Pr(r, "", t.sourceSpan, s, a);
                this._addToParent(o);
            }
    ...
    var Wr = null, Yo = ()=>(Wr || (Wr = new us), Wr);
    function Jt(e, t = {}) {
        ...
        return Yo().parse(e, "angular-html-parser", {
...
`) {
            ...
            case "attribute":
                {
                    ...
                    let i = Er(n.value), s = It(n, t) ? "" : pn(i, '"');
                    return [
                        n.rawName,
                        "=",
                        s,
    ...
    var tr = {
        ...
        setProperty(t, r) {
            if (this[t] !== r) {
                if (t in tr && (r = r.map((n)=>this.createChild(n))), !Ss.has(t)) {
                    this[t] = r;
                    return;
                }
    ...
    function Es(e, t) {
        if (e.value) for (let { regex: r, parse: n } of ml){
    ...
    var jr = class extends Or {
        ...
        visit(t, { parseOptions: r }) {
            Cl(t), vl(t, r), bl(t, r), Tl(t);
        }
    };
    function Ts(e, t, r, n) {
        Gt(new jr, e.children, {
            parseOptions: r
    ...
    function bl(e, t) {
        if (e.kind === "element" && (t.normalizeTagName && (!e.namespace || e.namespace === e.tagDefinition.implicitNamespacePrefix || ce(e)) && (e.name = Cs(e.name, (r)=>_s.has(r))), t.normalizeAttributeName)) for (let r of e.attrs)r.namespace || (r.name = Cs(r.name, (n)=>er.has(e.name) && (er.get("*").has(n) || er.get(e.name).has(n))));
    }
    function Kr(e, t) {
    ...
    function bs(e, t) {
        let r = $r(t), { rootNodes: n, errors: i } = Jt(e, r);
        if (n.some((u)=>u.kind === "docType" && u.value === "html" || u.kind === "element" && u.name.toLowerCase() === "html")) return Kr(e, nr);
        let a, o = ()=>a ?? (a = Jt(e, {
                ...r,
    ...
    function Qr(e, t, r, n = {}) {
        let { frontMatter: i, content: s } = r.shouldParseFrontMatter ? hr(e) : {
            content: e
        ...
        return Ts(d, S, u, (g, E)=>kl(t, e, g, E, u, n));
    }
    var nr = Zt({
        name: "html",
        normalizeTagName: !0,
    ...
    var Al = dt(nr), yl = new Set([
        "mj-style",
        "mj-raw"
    ]), xl = dt({
        ...nr,
        name: "mjml",
        shouldParseAsRawText: (e)=>yl.has(e)
    }), Nl = dt({
        name: "angular",
...
//# sourceMappingURL=b0a32_prettier_plugins_html_9acdc2e4.js.map