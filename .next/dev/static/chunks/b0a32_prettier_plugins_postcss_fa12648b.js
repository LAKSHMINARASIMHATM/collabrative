...
"[project]/node_modules/.pnpm/prettier@3.7.4/node_modules/prettier/plugins/postcss.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
(function(f) {
    ...
    var w = (t, e)=>()=>(e || t((e = {
                exports: {}
            }).exports, e), e.exports), sn = (t, e)=>{
        for(var s in e)bt(t, s, {
            get: e[s],
            enumerable: !0
        });
    }, nn = (t, e, s, r)=>{
        if (e && typeof e == "object" || typeof e == "function") for (let n of Sl(e))!Tl.call(t, n) && n !== s && bt(t, n, {
            get: ()=>e[n],
            enumerable: !(r = El(e, n)) || r.enumerable
        });
        return t;
    };
    var Te = (t, e, s)=>(s = t != null ? bl(kl(t)) : {}, nn(e || !t || !t.__esModule ? bt(s, "default", {
            value: t,
            enumerable: !0
        }) : s, t)), Al = (t)=>nn(bt({}, "__esModule", {
            value: !0
        }), t);
    var Ci = w((lx, os)=>{
        var x = String, Oi = function() {
            return {
                isColorSupported: !1,
                reset: x,
                bold: x,
    ...
    var jt = w((px, Ri)=>{
        "use strict";
        var Ni = Ci(), Pi = as(), st = class t extends Error {
...
`);
    ...
    var ut = w((yx, Di)=>{
        "use strict";
        var qc = jt(), Lc = Ht(), Dc = it(), { isClean: ot, my: Mc } = Kt();
        function cs(t, e) {
...
` ? (s = 1, r += 1) : s += 1;
            ...
            toJSON(e, s) {
                ...
                for(let o in this){
                    ...
                    if (Array.isArray(u)) r[o] = u.map((a)=>typeof a == "object" && a.toJSON ? a.toJSON(null, s) : a);
                        ...
                        if (u == null) continue;
                        let a = s.get(u.input);
                        a == null && (a = i, s.set(u.input, i), i++), r[o] = {
                            end: u.end,
                            inputId: a,
                            start: u.start
                        };
    ...
    var fe = w((vx, ji)=>{
        "use strict";
        var Ui = Me(), Fi = ft(), Fc = ut(), { isClean: $i, my: Wi } = Kt(), fs, Gi, Yi, ps;
        function Vi(t) {
            return t.map((e)=>(e.nodes && (e.nodes = Vi(e.nodes)), delete e.source, e));
        }
        function zi(t) {
        ...
        var z = class t extends Fc {
            ...
            normalize(e, s) {
                ...
                } else if (e.selector || e.selectors) e = [
                    new ps(e)
                ];
                else if (e.name) e = [
                    new fs(e)
                ...
                return e.map((n)=>(n[Wi] || t.rebuild(n), n = n.proxyOf, n.parent && n.parent.removeChild(n), n[$i] && zi(n), n.raws || (n.raws = {}), typeof n.raws.before > "u" && s && typeof s.raws.before < "u" && (n.raws.before = s.raws.before.replace(/\S/g, "")), n.parent = this.proxyOf, n));
            }
            prepend(...e) {
                e = e.reverse();
                for (let s of e){
        ...
        z.default = z;
        z.rebuild = (t)=>{
            t.type === "atrule" ? Object.setPrototypeOf(t, fs.prototype) : t.type === "rule" ? Object.setPrototypeOf(t, ps.prototype) : t.type === "decl" ? Object.setPrototypeOf(t, Fi.prototype) : t.type === "comment" ? Object.setPrototypeOf(t, Ui.prototype) : t.type === "root" && Object.setPrototypeOf(t, Yi.prototype), t[Wi] = !0, t.nodes && t.nodes.forEach((e)=>{
                z.rebuild(e);
            });
        };
    });
    ...
    var Ue = w((kx, ro)=>{
        "use strict";
        var { nanoid: Yc } = Ki(), { isAbsolute: ys, resolve: gs } = {}, { SourceMapConsumer: Vc, SourceMapGenerator: zc } = Qi(), { fileURLToPath: Ji, pathToFileURL: Qt } = {}, Zi = jt(), jc = hs(), ds = as(), ms = Symbol("lineToIndexCache"), Hc = !!(Vc && zc), eo = !!(gs && ys);
        function to(t) {
            if (t[ms]) return t[ms];
            let e = t.css.split(`
`), s = new Array(e.length), r = 0;
        ...
        var Be = class {
            ...
            constructor(e, s = {}){
                ...
                if (this.css = e.toString(), this.css[0] === "\uFEFF" || this.css[0] === "\uFFFE" ? (this.hasBOM = !0, this.css = this.css.slice(1)) : this.hasBOM = !1, this.document = this.css, s.document && (this.document = s.document.toString()), s.from && (!eo || /^\w+:\/\//.test(s.from) || ys(s.from) ? this.file = s.from : this.file = gs(s.from)), eo && Hc) {
            ...
            error(e, s, r, n = {}) {
                ...
                return f ? l = new Zi(e, f.endLine === void 0 ? f.line : {
                    column: f.column,
                    line: f.line
                }, f.endLine === void 0 ? f.column : {
                    column: f.endColumn,
                    line: f.endLine
                }, f.source, f.file, n.plugin) : l = new Zi(e, o === void 0 ? s : {
                    column: r,
                    line: s
                }, o === void 0 ? r : {
                    column: i,
                    ...
                    offset: a,
                    source: this.css
                }, this.file && (Qt && (l.input.url = Qt(this.file).toString()), l.input.file = this.file), l;
            }
            fromLineAndColumn(e, s) {
                return to(this)[e - 1] + s - 1;
            }
            fromOffset(e) {
                let s = to(this), r = s[s.length - 1], n = 0;
                if (e >= r) n = s.length - 1;
                else {
                    let i = s.length - 2, o;
            ...
            origin(e, s, r, n) {
                ...
                let a;
                ys(o.source) ? a = Qt(o.source) : a = new URL(o.source, this.map.consumer().sourceRoot || Qt(this.map.mapFile));
                let l = {
                    column: o.column,
                ...
                if (a.protocol === "file:") if (Ji) l.file = Ji(a);
    ...
    var $e = w((Ax, uo)=>{
        "use strict";
        var io = fe(), oo, ao, pe = class extends io {
            constructor(e){
...
`,
    ...
    var Jt = w((Cx, fo)=>{
        "use strict";
        var co = fe(), Kc = ws(), We = class extends co {
            get selectors() {
        ...
        ho.exports = function(e, s = {}) {
            ...
            function H(W) {
                ...
                switch(i = r.charCodeAt(p), i){
                    ...
                    case 64:
                        {
                            Zt.lastIndex = p + 1, Zt.test(r), Zt.lastIndex === 0 ? a = r.length - 1 : a = Zt.lastIndex - 2, f = [
                                "at-word",
                                r.slice(p, a + 1),
                                p,
                                a
                    ...
                    case 92:
                        {
                            ...
                            if (i = r.charCodeAt(a + 1), u && i !== 47 && i !== 32 && i !== 10 && i !== 9 && i !== 13 && i !== 12 && (a += 1, po.test(r.charAt(a)))) {
                    ...
                    default:
                        {
                            i === 47 && r.charCodeAt(p + 1) === 42 ? (a = r.indexOf("*/", p + 2) + 1, a === 0 && (n || A ? a = r.length : O("comment")), f = [
                                ...
                                p,
                                a
                            ], p = a) : (er.lastIndex = p + 1, er.test(r), er.lastIndex === 0 ? a = r.length - 1 : a = er.lastIndex - 2, f = [
                                "word",
                                r.slice(p, a + 1),
                                p,
                                a
    ...
    var rr = w((Px, go)=>{
        "use strict";
        var Xc = Xt(), Jc = Me(), Zc = ft(), ef = $e(), mo = Jt(), tf = tr(), yo = {
            empty: !0,
            space: !0
        };
        function rf(t) {
        ...
        var vs = class {
            ...
            decl(e, s) {
                ...
                for(; e.length;)if (i = e.shift(), i[0] === ":") {
                    r.raws.between += i[1];
                    break;
                } else i[0] === "word" && /\w/.test(i[1]) && this.unknownWord([
                    i
                ]), r.raws.between += i[1];
            ...
            raw(e, s, r, n) {
                ...
                for(let c = 0; c < u; c += 1)i = r[c], o = i[0], o === "space" && c === u - 1 && !n ? l = !1 : o === "comment" ? (h = r[c - 1] ? r[c - 1][0] : "empty", f = r[c + 1] ? r[c + 1][0] : "empty", !yo[h] && !yo[f] ? a.slice(-1) === "," ? l = !1 : a += i[1] : l = !1) : a += i[1];
                if (!l) {
...
`));
    ...
    var Ro = w((Ux, Po)=>{
        var df = Me(), mf = rr(), { isInlineComment: yf } = vo(), { interpolation: No } = _o(), { isMixinToken: gf } = Eo(), wf = ko(), vf = Co(), xf = /(!\s*important)$/i;
        Po.exports = class extends mf {
            constructor(...e){
                super(...e), this.lastNode = null;
            }
            atrule(e) {
                No.bind(this)(e) || (super.atrule(e), wf(this.lastNode), vf(this.lastNode));
            }
            decl(...e) {
            ...
            mixin(e) {
                ...
                if ((n < 0 || n > 3) && i > 0) {
                    let l = e.reduce((v, O, q)=>O[0] === ")" ? q : v), h = e.slice(i, l + i).map((v)=>v[1]).join(""), [c] = e.slice(i), g = [
                        c[2],
                        c[3]
                    ], [b] = e.slice(l, l + 1), d = [
                        b[2],
            ...
            rule(e) {
                ...
                if (r[0] === "at-word" && s[0] === "{" && (this.tokenizer.back(s), No.bind(this)(r))) {
                    let i = this.tokenizer.nextToken();
                    e = e.slice(0, e.length - 2).concat([
                        i
                    ]);
    ...
    var nr = w((Gx, Bo)=>{
        "use strict";
        var kf = fe(), Do, Mo, be = class extends kf {
            constructor(e){
                super({
                    type: "document",
                    ...e
    ...
    var Fo = w((Yx, Uo)=>{
        "use strict";
        var Tf = Xt(), Af = Me(), Of = ft(), Cf = Ue(), Nf = hs(), Pf = $e(), Rf = Jt();
        function dt(t, e) {
    ...
    var Ss = w((Kx, Vo)=>{
        ...
        Vo.exports = function(e) {
            Yo[e] || (Yo[e] = !0, typeof console < "u" && console.warn && console.warn(e));
        };
    });
    var As = w((Xx, Ko)=>{
        "use strict";
        var qf = fe(), Lf = nr(), Df = bs(), Mf = ht(), zo = ir(), Bf = $e(), Uf = it(), { isClean: Q, my: Ff } = Kt(), Qx = Ss(), $f = {
            atrule: "AtRule",
            comment: "Comment",
            decl: "Declaration",
            document: "Document",
        ...
        var Ts = {}, he = class t {
            ...
            constructor(e, s, r){
                ...
                else if (s instanceof t || s instanceof zo) n = ks(s.root), s.map && (typeof r.map > "u" && (r.map = {}), r.map.inline || (r.map.inline = !1), r.map.prev = s.map);
                else {
                    let i = Mf;
                ...
                this.result = new zo(e, n, r), this.helpers = {
                    ...Ts,
                    postcss: Ts,
                    result: this.result
    ...
    var Xo = w((Zx, Qo)=>{
        "use strict";
        var Yf = bs(), Vf = ht(), zf = ir(), jf = it(), Jx = Ss(), wt = class {
            get content() {
    ...
    var Zo = w((e_, Jo)=>{
        "use strict";
        var Hf = nr(), Kf = As(), Qf = Xo(), Xf = $e(), Ee = class {
            constructor(e = []){
    ...
    var or = w((t_, oa)=>{
        "use strict";
        var ea = Xt(), ta = Me(), Jf = fe(), Zf = jt(), ra = ft(), sa = nr(), ep = Fo(), tp = Ue(), rp = As(), sp = ws(), np = ut(), ip = ht(), Os = Zo(), op = ir(), na = $e(), ia = Jt(), ap = it(), up = Es();
        function S(...t) {
...
https://evilmartians.com/chronicles/postcss-8-plugin-migration`));
    ...
    var ua = w((r_, aa)=>{
        var { Container: lp } = or(), Cs = class extends lp {
            constructor(e){
        ...
        ca.exports = function(e, s = {}) {
            ...
            function ne(A) {
                ...
                switch(i = r.charCodeAt(d), i){
                    ...
                    case 64:
                        {
                            ar.lastIndex = d + 1, ar.test(r), ar.lastIndex === 0 ? o = r.length - 1 : o = ar.lastIndex - 2, g = [
                                "at-word",
                                r.slice(d, o + 1),
                                d,
                                o
                    ...
                    case 92:
                        {
                            ...
                            if (i = r.charCodeAt(o + 1), l && i !== 47 && i !== 32 && i !== 10 && i !== 9 && i !== 13 && i !== 12 && (o += 1, la.test(r.charAt(o)))) {
                    ...
                    default:
                        c = r.charCodeAt(d + 1), i === 35 && c === 123 ? (o = d, H(), a = r.slice(d, o + 1), g = [
                            ...
                            d,
                            o
                        ], d = o) : i === 47 && c === 47 ? (lr.lastIndex = d + 1, lr.test(r), lr.lastIndex === 0 ? o = r.length - 1 : o = lr.lastIndex - 2, a = r.slice(d, o + 1), g = [
                            "comment",
                            a,
                            d,
                            o,
                            "inline"
                        ], d = o) : (ur.lastIndex = d + 1, ur.test(r), ur.lastIndex === 0 ? o = r.length - 1 : o = ur.lastIndex - 2, g = [
                            "word",
                            r.slice(d, o + 1),
                            d,
                            o
    ...
    var ha = w((n_, pa)=>{
        var { Comment: fp } = or(), pp = rr(), hp = ua(), dp = fa(), Ns = class extends pp {
            atrule(e) {
                let s = e[1], r = e;
                for(; !this.tokenizer.endOfFile();){
...
`)) break;
    ...
    var _a = w((xt)=>{
        ...
        var bp = Rs(), wa = va(bp), Ep = qs(), Ls = va(Ep);
        function va(t) {
            return t && t.__esModule ? t : {
                default: t
            };
        ...
        function Ds(t) {
            ...
            for(var u = 0; u < t.length; u++){
                ...
                n ? (i.value += a, (a === "{" || a === "(") && r++, (a === ")" || a === "}") && r--) : a.search(/\s/) !== -1 ? i.before += a : (a === "(" && (i.type = "media-feature-expression", r++), i.value = a, i.sourceIndex = e + u, n = !0), n && r === 0 && (a === ")" || u === t.length - 1 || t[u + 1].search(/\s/) !== -1) && ([
                    ...
                    "only",
                    "and"
                ].indexOf(i.value) !== -1 && (i.type = "keyword"), i.type === "media-feature-expression" && (i.nodes = xa(i.value, i.sourceIndex)), s.push(Array.isArray(i.nodes) ? new Ls.default(i) : new wa.default(i)), i = o(), n = !1);
            }
    ...
    var ke = w((cr, Ca)=>{
        "use strict";
        cr.__esModule = !0;
        var Oa = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? function(t) {
            return typeof t;
        } : function(t) {
        ...
        var Dp = function t(e, s) {
            ...
            for(var n in e)if (e.hasOwnProperty(n)) {
                var i = e[n], o = typeof i > "u" ? "undefined" : Oa(i);
    ...
    var B = w((U)=>{
        "use strict";
        U.__esModule = !0;
        var v_ = U.TAG = "tag", x_ = U.STRING = "string", __ = U.SELECTOR = "selector", b_ = U.ROOT = "root", E_ = U.PSEUDO = "pseudo", S_ = U.NESTING = "nesting", k_ = U.ID = "id", T_ = U.COMMENT = "comment", A_ = U.COMBINATOR = "combinator", O_ = U.CLASS = "class", C_ = U.ATTRIBUTE = "attribute", N_ = U.UNIVERSAL = "universal";
    });
    var pr = w((fr, Na)=>{
        "use strict";
        fr.__esModule = !0;
    ...
    var pu = w((Cr, fu)=>{
        ...
        Cr.__esModule = !0;
        Cr.default = tm;
        var nu = 39, Vd = 34, Ws = 92, iu = 47, _t = 10, Gs = 32, Ys = 12, Vs = 9, zs = 13, ou = 43, au = 62, uu = 126, lu = 124, zd = 44, jd = 40, Hd = 41, Kd = 91, Qd = 93, Xd = 59, cu = 42, Jd = 58, Zd = 38, em = 64, Ar = /[ \n\t\r\{\(\)'"\\;/]/g, Or = /[ \n\t\r\(\)\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g;
        function tm(t) {
            for(var e = [], s = t.css.valueOf(), r = void 0, n = void 0, i = void 0, o = void 0, u = void 0, a = void 0, l = void 0, f = void 0, h = void 0, c = void 0, g = void 0, b = s.length, d = -1, p = 1, m = 0, y = function(O, q) {
                ...
                switch(r = s.charCodeAt(m), r === _t && (d = m, p += 1), r){
                    ...
                    case Vd:
                        i = r === nu ? "'" : '"', n = m;
                        do for(c = !1, n = s.indexOf(i, n + 1), n === -1 && y("quote", i), g = n; s.charCodeAt(g - 1) === Ws;)g -= 1, c = !c;
                        while (c)
                        e.push([
                            "string",
                            s.slice(m, n + 1),
                        ...
                        break;
                    case em:
                        Ar.lastIndex = m + 1, Ar.test(s), Ar.lastIndex === 0 ? n = s.length - 1 : n = Ar.lastIndex - 2, e.push([
                            "at-word",
                            s.slice(m, n + 1),
                            p,
                            m - d,
                    ...
                    case Ws:
                        ...
                        r = s.charCodeAt(n + 1), l && r !== iu && r !== Gs && r !== _t && r !== Vs && r !== zs && r !== Ys && (n += 1), e.push([
                            "word",
                            s.slice(m, n + 1),
                            p,
                            m - d,
                        ...
                        break;
                    default:
                        r === iu && s.charCodeAt(m + 1) === cu ? (n = s.indexOf("*/", m + 2) + 1, n === 0 && y("comment", "*/"), a = s.slice(m, n + 1), o = a.split(`
`), u = o.length - 1, u > 0 ? (f = p + u, h = n - o[u].length) : (f = p, h = d), e.push([
                            ...
                            n - h,
                            m
                        ]), d = h, p = f, m = n) : (Or.lastIndex = m + 1, Or.test(s), Or.lastIndex === 0 ? n = s.length - 1 : n = Or.lastIndex - 2, e.push([
                            "word",
                            s.slice(m, n + 1),
                            p,
                            m - d,
    ...
    var mu = w((Nr, du)=>{
        ...
        }(), sm = Us(), nm = I(sm), im = Fs(), js = I(im), om = $s(), am = I(om), um = Ra(), lm = I(um), cm = qa(), Hs = I(cm), fm = Ma(), pm = I(fm), hm = Ua(), dm = I(hm), mm = $a(), ym = I(mm), gm = Ga(), wm = I(gm), vm = Va(), xm = I(vm), _m = ja(), bm = I(_m), Em = Ka(), Sm = I(Em), km = Xa(), Tm = I(km), Am = Za(), Om = I(Am), Cm = tu(), Nm = I(Cm), Pm = su(), Rm = I(Pm), Im = pu(), hu = I(Im), qm = B(), Lm = Dm(qm);
        function Dm(t) {
            if (t && t.__esModule) return t;
            var e = {};
            if (t != null) for(var s in t)Object.prototype.hasOwnProperty.call(t, s) && (e[s] = t[s]);
        ...
        var Bm = function() {
            function t(e) {
                ...
                return this.root.append(s), this.current = s, this.lossy ? this.tokens = (0, hu.default)({
                    safe: e.safe,
                    css: e.css.trim()
                }) : this.tokens = (0, hu.default)(e), this.loop();
            }
...
` ? (r = 1, n += 1) : r += 1;
    ...
    var Cu = w((G_, Ou)=>{
        "use strict";
        var Km = F(), Qm = j(), Ir = class extends Qm {
            constructor(e){
    ...
    var Pu = w((Y_, Nu)=>{
        "use strict";
        var Xm = F(), Jm = j(), qr = class extends Jm {
            constructor(e){
    ...
    var Iu = w((V_, Ru)=>{
        "use strict";
        var Zm = F(), ey = j(), Lr = class extends ey {
            constructor(e){
    ...
    var Bu = w((j_, Mu)=>{
        "use strict";
        var ty = F(), ry = j(), Mr = class extends ry {
            constructor(e){
    ...
    var Fu = w((H_, Uu)=>{
        "use strict";
        var sy = F(), ny = j(), Br = class extends ny {
            constructor(e){
    ...
    var Wu = w((K_, $u)=>{
        "use strict";
        var iy = F(), oy = j(), Ur = class extends oy {
            constructor(e){
    ...
    var Yu = w((Q_, Gu)=>{
        "use strict";
        var ay = F(), uy = j(), Fr = class extends uy {
            constructor(e){
    ...
    var zu = w((X_, Vu)=>{
        "use strict";
        var ly = F(), cy = j(), $r = class extends cy {
            constructor(e){
    ...
    var Hu = w((J_, ju)=>{
        "use strict";
        var fy = F(), py = j(), Wr = class extends py {
            constructor(e){
    ...
    var Zu = w((eb, Ju)=>{
        "use strict";
        var Gr = /[ \n\t\r\{\(\)'"\\;,/]/g, hy = /[ \n\t\r\(\)\{\}\*:;@!&'"\+\|~>,\[\]\\]|\/(?=\*)/g, ze = /[ \n\t\r\(\)\{\}\*:;@!&'"\-\+\|~>,\[\]\\]|\//g, dy = /^[a-z0-9]/i, my = /^[a-f0-9?\-]/i, Xu = Qu();
        Ju.exports = function(e, s) {
            ...
            for(; a < i;){
                switch(h = n.charCodeAt(a), h === 10 && (o = a, u += 1), h){
                    ...
                    case 34:
                        g = h === 39 ? "'" : '"', c = a;
                        do for(O = !1, c = n.indexOf(g, c + 1), c === -1 && ne("quote", g), q = c; n.charCodeAt(q - 1) === 92;)q -= 1, O = !O;
                        while (O)
                        r.push([
                            "string",
                            n.slice(a, c + 1),
                        ...
                        break;
                    case 64:
                        Gr.lastIndex = a + 1, Gr.test(n), Gr.lastIndex === 0 ? c = n.length - 1 : c = Gr.lastIndex - 2, r.push([
                            "atword",
                            n.slice(a, c + 1),
                            u,
                            a - o,
                        ...
                        break;
                    case 92:
                        c = a, h = n.charCodeAt(c + 1), m && h !== 47 && h !== 32 && h !== 10 && h !== 9 && h !== 13 && h !== 12 && (c += 1), r.push([
                            "word",
                            n.slice(a, c + 1),
                            u,
                            a - o,
...
`), d = b.length - 1, d > 0 ? (y = u + d, v = c - b[d].length) : (y = u, v = o), r.push([
    ...
    var il = w((sb, nl)=>{
        "use strict";
        var yy = bu(), gy = Su(), wy = Au(), vy = Cu(), xy = Pu(), _y = Iu(), by = Du(), Ey = Bu(), Sy = Fu(), rl = Wu(), ky = Yu(), sl = zu(), Ty = Hu(), Ay = Zu(), Oy = Us(), Cy = Fs(), Ny = $s(), Py = tl();
        function Ry(t) {
        ...
        nl.exports = class {
            ...
            parenOpen() {
                ...
                if (e && this.error("Expected closing parenthesis", r), n = this.current.last, n && n.type === "func" && n.unbalanced < 0 && (n.unbalanced = 0, this.current = n), this.current.unbalanced++, this.newNode(new rl({
                    value: r[1],
                    source: {
                        start: {
                            line: r[2],
                    ...
                    this.position !== this.tokens.length - 1 && (this.position++, this.newNode(new sl({
                        value: o,
                        source: {
                            start: u,
                            end: {
    ...
    var Et = (t, e)=>(s, r, ...n)=>s | 1 && r == null ? void 0 : (e.call(r) ?? r[t]).apply(r, n);
    ...
    var Rl = ()=>{}, K = Rl;
    var je = "string", He = "array", St = "cursor", ie = "indent", Ae = "align", kt = "trim", oe = "group", ae = "fill", me = "if-break", Tt = "indent-if-break", Oe = "line-suffix", At = "line-suffix-boundary", X = "line", Ot = "label", Ce = "break-parent", Ct = new Set([
        St,
        ie,
        Ae,
        kt,
    ...
    var ue = Il;
    var ql = (t)=>new Intl.ListFormat("en-US", {
            type: "disjunction"
        }).format(t);
    function Ll(t) {
...
Expected it to be ${r}.`;
    ...
    function jl(t, e) {
        ...
        let s = t.slice(1, -1), r = e.parser === "json" || e.parser === "jsonc" || e.parser === "json5" && e.quoteProps === "preserve" && !e.singleQuote ? '"' : e.__isInHtmlAttribute ? "'" : hn(s, e.singleQuote);
...
`)), G(0, l, -1).length;
    ...
    var gn = yn;
    function wn() {}
    wn.getVisitorKeys = (t)=>t.type === "css-root" ? [
            "frontMatter"
        ] : [];
    var vn = wn;
    var Qe = null;
    ...
    function ec(t, e = "type") {
        ...
        function s(r) {
            let n = r[e], i = t[n];
            if (!Array.isArray(i)) throw Object.assign(new Error(`Missing visitor keys for '${n}'.`), {
                node: r
            });
            return i;
        }
...
`, s) + 1;
    ...
    var Uw = It(/\s/u), qt = It(" 	"), En = It(",; 	"), Lt = It(/[^\n\r]/u);
    function Sn(t, e) {
        let { value: s } = t;
    ...
    function kn(t, e) {
        ...
        if (typeof t.sourceIndex == "number") return t.type === "value-word" ? Sn(t, t.sourceIndex) : t.sourceIndex;
    ...
    function Qr(t, e) {
        if (t.type === "css-comment" && t.inline) return Lt(e, t.source.startOffset);
    ...
    function Xr(t, e) {
        t.source && (t.source.startOffset = kn(t, e), t.source.endOffset = Qr(t, e));
        for(let s in t){
            let r = t[s];
            s === "source" || !r || typeof r != "object" || (r.type === "value-root" || r.type === "value-unknown" ? Tn(r, sc(t), r.text || r.value) : Xr(r, e));
        }
    }
    function Tn(t, e, s) {
        t.source && (t.source.startOffset = kn(t, s) + e, t.source.endOffset = Qr(t, s) + e);
        for(let r in t){
            let n = t[r];
...
`);
        ...
        let r = Object.create(null), n = E(0, t, Cn, "").replace(On, "").trimEnd(), i;
        for(; i = Cn.exec(t);){
            let o = E(0, i[2], oc, "");
    ...
    function Dn({ comments: t = "", pragmas: e = {} }) {
        let o = Object.keys(e), u = o.flatMap((l)=>Nn(l, e[l])).map((l)=>` * ${l}
`).join("");
        if (!t) {
...
`);
    ...
    function Jr(t) {
        ...
        let s = In(t), { pragmas: r, comments: n } = Ln(s);
        return {
            shebang: e,
            text: t,
            pragmas: r,
    ...
    function Gn(t) {
        let { shebang: e, text: s, pragmas: r, comments: n } = Jr(t), i = qn(s), o = Dn({
            pragmas: {
                [Un]: "",
                ...r
            },
...
`) + i;
    ...
    var Yn = (t)=>$n(ge(t).content), Vn = (t)=>Wn(ge(t).content), zn = (t)=>{
...
` : "") + Gn(s);
    ...
    function Kn(t, e) {
        return t.findAncestor((r)=>r.type === "css-atrule")?.name?.toLowerCase().endsWith("keyframes") && [
            "from",
            "to"
    ...
    function hc(t, e, s) {
        let { node: r } = t, n = t.parent, i = t.grandparent, o = jn(t), u = o && n.type === "value-value" && (o === "grid" || o.startsWith("grid-template")), a = t.findAncestor((p)=>p.type === "css-atrule"), l = a && Je(a, e), f = r.groups.some((p)=>Ze(p)), h = t.map(s, "groups"), c = [
            ""
        ], g = qe(t, "url"), b = !1, d = !1;
        for(let p = 0; p < r.groups.length; ++p){
            ...
            if (b || Wt(y) || Wt(v) || y.type === "value-atword" && (y.value === "" || y.value.endsWith("[")) || v.type === "value-word" && v.value.startsWith("]") || y.value === "~" || e.parser === "less" && (v?.type === "value-word" && v.value === "[" || y.type === "value-word" && y.value === "[" && (v?.type === "value-atword" || v?.type === "value-word") || y.type === "value-word" && y.value === "][" && v?.type === "value-word") || y.type !== "value-string" && y.value && y.value.includes("\\") && v && v.type !== "value-comment" || m?.value && m.value.indexOf("\\") === m.value.length - 1 && y.type === "value-operator" && y.value === "/" || y.value === "\\" || ai(y, v) || Ft(y) || rs(y) || $t(v) || rs(v) && Z(v) || $t(y) && Z(v) || y.value === "--" && Ft(v)) continue;
            let q = Mt(y), H = Mt(v);
            if ((q && Ft(v) || H && $t(y)) && Z(v) || !m && ve(y) || qe(t, "calc") && (J(y) || J(v) || xe(y) || xe(v)) && Z(v)) continue;
            let ne = (J(y) || xe(y)) && p === 0 && (v.type === "value-number" || v.isHex) && i && pi(i) && !Z(v);
            ...
            if (!(!(Dt(v) || Dt(y)) && !qe(t, "calc") && !ne && (ve(v) && !W || ve(y) && !A || J(v) && !W || J(y) && !A || xe(v) || xe(y)) && (Z(v) || q && (!m || m && Mt(m)))) && !((e.parser === "scss" || e.parser === "less") && q && y.value === "-" && rt(v) && R(y) === P(v.open) && v.open.value === "(")) {
                if (Ze(y)) {
                ...
                if (u) {
                    y.source && v.source && y.source.start.line !== v.source.start.line ? (c.push(T, ""), d = !0) : c.push([
                        c.pop(),
                        " "
                    ]);
                    continue;
                }
                if (!(o && (o === "font" || o.startsWith("--")) && (ve(v) && Z(v) && di(y) || ve(y) && Z(y) && di(m)))) {
                    if (H) {
                        c.push([
                            c.pop(),
                            " "
        ...
        return f && c.push([
            c.pop(),
            Ne
        ]), d && c.unshift("", T), l ? D(L(c)) : Xn(t) ? D(Pe(c)) : D(L(Pe(c)));
    }
    function di(t) {
    ...
    var gi = /(["'])(?:(?!\1)[^\\]|\\.)*\1/gsu, mc = /(?:\d*\.\d+|\d+\.?)(?:e[+-]?\d+)?/giu, yc = /[a-z]+/giu, gc = /[$@]?[_a-z\u0080-\uFFFF][\w\u0080-\uFFFF-]*/giu, wc = new RegExp(gi.source + `|(${gc.source})?(${mc.source})(${yc.source})?`, "giu");
    function V(t, e) {
    ...
    function _e(t) {
        return E(0, t, wc, (e, s, r, n, i)=>!r && n && (i ?? (i = ""), i = i.toLowerCase(), !i || i === "n" || Gt.has(i)) ? ns(n) + (i ? ss(i) : "") : e);
    }
    function ns(t) {
...
`) return e + 2;
    ...
    var Yt = vc;
    function xc(t, e, s = {}) {
        let r = qt(t, s.backwards ? e - 1 : e, s), n = Yt(t, r, s);
        return r !== n;
    }
    var Vt = xc;
    function _c(t, e) {
    ...
    var _i = _c;
    function bc(t, e) {
        return e === !1 ? !1 : t.charAt(e) === "/" && t.charAt(e + 1) === "/" ? Lt(t, e) : e;
    }
    var bi = bc;
    function Ec(t, e) {
        let s = null, r = e;
    ...
    function kc(t, e) {
        return Zn(t.grandparent) && Sc(t, e) ? "," : t.node.type !== "value-comment" && !(t.node.type === "value-comma_group" && t.node.groups.every((s)=>s.type === "value-comment")) && vi(e) && t.callParent(()=>ts(t, e)) ? Nt(",") : "";
    }
    function Ei(t, e, s) {
        let { node: r, parent: n } = t, i = t.map(({ node: g })=>typeof g == "string" ? g : s(), "groups");
        if (n && Jn(n) && (r.groups.length === 1 || r.groups.length > 0 && r.groups[0].type === "value-comma_group" && r.groups[0].groups.length > 0 && r.groups[0].groups[0].type === "value-word" && r.groups[0].groups[0].value.startsWith("data:"))) return [
            r.open ? s("open") : "",
            Y(",", i),
            r.close ? s("close") : ""
        ];
        ...
        let o = t.map(({ node: g, isLast: b, index: d })=>{
            let p = i[d];
            Ut(g) && g.type === "value-comma_group" && g.groups && g.groups[0].type !== "value-paren_group" && g.groups[2]?.type === "value-paren_group" && ue(p) === oe && ue(p.contents) === ie && ue(p.contents.contents) === ae && (p = D(le(p)));
            let m = [
                p,
                b ? kc(t, e) : ","
            ];
            if (!b && g.type === "value-comma_group" && ce(g.groups)) {
                ...
                !y.source && y.close && (y = y.close), y.source && zt(e.originalText, R(y)) && m.push(T);
            }
            return m;
        }, "groups"), u = ci(r, n), a = hi(r, n), l = ts(t, e), f = a || l && !u, h = a || u, c = D([
            r.open ? s("open") : "",
            L([
                M,
                Y(C, o)
    ...
    function Oc(t, e, s) {
        ...
        return t.each(()=>{
            ...
            let { next: o } = t;
            o.type === "css-comment" && !Vt(e.originalText, P(o), {
                backwards: !0
            }) && !Re(n) || o.type === "css-atrule" && o.name === "else" && n.type !== "css-comment" ? r.push(" ") : (r.push(e.__isHTMLStyleAttribute ? C : T), zt(e.originalText, R(n)) && !Re(n) && r.push(T));
        }, "nodes"), r;
    }
    var De = Oc;
    function Cc(t, e, s) {
        ...
        switch(r.type){
            ...
            case "css-decl":
                {
                    ...
                    return l = ui(r) ? an(l) : l, !u && Le(o) && !t.call(()=>is(t), "value", "group", "group") && (l = L([
                        T,
                        le(l)
                    ])), [
                        E(0, r.raws.before, /[\s;]/gu, ""),
                        n.type === "css-atrule" && n.variable || Qn(t) ? r.prop : Ie(r.prop),
                        o.startsWith("//") ? " " : "",
                        o,
                        r.extend || a ? "" : " ",
                        ...
                        r.nodes ? [
                            ...
                            M,
                            "}"
                        ] : oi(r) && !n.raws.semicolon && e.originalText[R(r) - 1] !== ";" ? "" : e.__isHTMLStyleAttribute && t.isLast ? Nt(";") : ";"
                    ];
                }
            case "css-atrule":
                {
                    let n = t.parent, i = Bt(r) && !n.raws.semicolon && e.originalText[R(r) - 1] !== ";";
                    if (e.parser === "less") {
                        if (r.mixin) return [
                            s("selector"),
                            r.important ? " !important" : "",
                    ...
                    return [
                        ...
                        r.params ? [
                            es(r) ? "" : Bt(r) ? r.raws.afterName === "" ? "" : r.name.endsWith(":") ? " " : /^\s*\n\s*\n/u.test(r.raws.afterName) ? [
                                T,
                                T
                            ] : /^\s*\n/u.test(r.raws.afterName) ? T : " " : " ",
                            typeof r.params == "string" ? r.params : s("params")
                        ] : "",
                        r.selector ? L([
                            " ",
            ...
            case "selector-root":
                return D([
                    we(t, "custom-selector") ? [
                        t.findAncestor((n)=>n.type === "css-atrule").customSelector,
                        C
                    ] : "",
                    Y([
                        ",",
            ...
            case "selector-tag":
                return [
                    ...
                    t.previous?.type === "selector-nesting" ? r.value : _e(Kn(t, r.value) ? r.value.toLowerCase() : r.value)
                ];
            case "selector-id":
                return [
                    "#",
            ...
            case "value-operator":
                return r.value;
            case "value-word":
                return r.isColor && r.isHex || Hn(r.value) ? r.value.toLowerCase() : r.value;
            case "value-colon":
                {
                    let { previous: n } = t;
                    return D([
    ...
    var ml = Te(ht(), 1), yl = Te(Lo(), 1), gl = Te(ma(), 1);
    function gp(t, e) {
    ...
    function qy(t) {
        return Yr(t).text.slice(t.group.open.sourceIndex + 1, t.group.close.sourceIndex).trim();
    }
    var ol = qy;
    function Ly(t) {
        if (ce(t)) {
    ...
    function By(t, e) {
        ...
        for(let a = 0; a < s.length; ++a){
            let l = s[a];
            if (e.parser === "scss" && l.type === "number" && l.unit === ".." && l.value.endsWith(".") && (l.value = l.value.slice(0, -1), l.unit = "..."), l.type === "func" && l.value === "selector" && (l.group.groups = [
                se(Yr(t).text.slice(l.group.open.sourceIndex + 1, l.group.close.sourceIndex))
                ...
                (al(h) || !ul(h) && !ll(h[0], e)) && (l.group.groups = [
                    ol(l)
                ]);
            }
            if (l.type === "paren" && l.value === "(") r = {
                ...
                if (a === s.length - 3 && s[a + 1].type === "comment" && cl(s[a + 2])) continue;
                r.groups.push(o), o = {
                    groups: [],
                    type: "comma_group"
                }, u[u.length - 1] = o;
    ...
    function Vr(t) {
        return t.type === "paren_group" && !t.open && !t.close && t.groups.length === 1 || t.type === "comma_group" && t.groups.length === 1 ? Vr(t.groups[0]) : t.type === "paren_group" || t.type === "comma_group" ? {
            ...t,
            groups: t.groups.map(Vr)
        } : t;
    }
    function pl(t, e) {
        if (Se(t)) for(let s in t)s !== "parent" && (pl(t[s], e), s === "nodes" && (t.group = Vr(By(t, e)), delete t[s]));
        return t;
    }
    function Uy(t, e) {
        ...
        if (Se(t)) {
            ...
            if (t.raws ?? (t.raws = {}), t.type === "css-decl" && typeof t.prop == "string" && t.prop.startsWith("--") && typeof t.value == "string" && t.value.startsWith("{")) {
                ...
                if (t.value.trimEnd().endsWith("}")) {
                    ...
                    e.parser === "scss" ? l = _l : e.parser === "less" ? l = xl : l = vl;
                    let f;
                    try {
                        f = l(a, {
                            ...e
            ...
            if (t.type === "css-atrule" && n.length > 0) {
                ...
                return i === "warn" || i === "error" ? (t.params = {
                    type: "media-unknown",
                    value: n
                }, t) : i === "extend" || i === "nest" ? (t.selector = se(n), delete t.params, t) : i === "at-root" ? (/^\(\s*(?:without|with)\s*:.+\)$/su.test(n) ? t.params = de(n, e) : (t.selector = se(n), delete t.params), t) : hl(o) ? (t.import = !0, delete t.filename, t.params = de(n, e), t) : [
                    "namespace",
                    "supports",
                    "if",
                    "else",
                    ...
                    "define-mixin",
                    "add-mixin"
                ].includes(i) ? (n = n.replace(/(\$\S+?)(\s+)?\.{3}/u, "$1...$2"), n = n.replace(/^(?!if)([^"'\s(]+)(\s+)\(/u, "$1($2"), t.value = de(n, e), delete t.params, t) : [
                    "media",
                    "custom-media"
                ].includes(o) ? n.includes("#{") ? {
                    type: "media-unknown",
                    value: n
                } : (t.params = Sa(n), t) : (t.params = n, t);
            }
        }
        return t;
    }
    function Js(t, e, s) {
        ...
        try {
            ...
            throw typeof l != "number" ? o : ya(`${u}: ${a}`, {
                loc: {
                    start: {
                        line: l,
                        column: f
        ...
        return s.originalText = e, i = wl(te(i, "css-"), s), Xr(i, e), r && (i.frontMatter = {
            ...r,
            type: "front-matter",
            source: {
...
//# sourceMappingURL=b0a32_prettier_plugins_postcss_fa12648b.js.map